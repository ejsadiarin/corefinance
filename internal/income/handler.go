...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	helper.Respond(w, http.StatusCreated, income)
}
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		helper.RespondError(w, http.StatusNotFound, "income not found")
		return
	}
	helper.Respond(w, http.StatusOK, income)
}
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	helper.Respond(w, http.StatusOK, incomes)
}
...
func (h *Handler) Skip(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		helper.RespondError(w, http.StatusBadRequest, "invalid income id")
		return
	}
	userID, ok := helper.GetUserID(w, r)
	if !ok {
...
func (h *Handler) GetOccurrences(w http.ResponseWriter, r *http.Request) {
	...
	helper.Respond(w, http.StatusOK, occurrences)
}
